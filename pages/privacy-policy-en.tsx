    ...
    <Wrapper>
      <Container>
        ...
        <Paragraph>
          ...
          information in this application provided by TinyKitten is as follows.
        </Paragraph>
        <HeadingText>1.Personal information</HeadingText>
        <Paragraph>
          “Personal information” refers to “personal information” as defined in
          the Personal Information Protection Law, and is information about
        ...
        <Paragraph>
          ...
          credit card number, driver&lsquo;s license number, etc. when
          registering for use. However, the location information of the user is
          temporarily acquired due to the characteristics of this application,
        ...
        <OrderedList>
          <li>
            ...
            only if it is reasonably deemed that the purpose of use is relevant
        ...
        <OrderedList>
          <li>
            ...
            the user, except for laws and regulations and other matters
            stipulated otherwise in this policy.
          </li>
          <li>
            Except as otherwise provided by TinyKitten, the revised Privacy
            Policy will take effect from the time it is posted on this website.
          </li>
        </OrderedList>
        ...
        <Paragraph>
          ...
          usage status of the site and application. Google Analytics uses
          cookies to collect user information on the site side, and collects the
          assigned ID automatically assigned to each launch of the application
          on the application side, but with the user&lsquo;s personal
          information Is not associated. For a description of the Google
          Analytics Terms of Service and Privacy Policy, please visit the Google
          Analytics website.
          <br />
        ...
        <Paragraph>
          ...
          stability of the application. TinyKitten receives the results of this
          analysis from Functional Software to understand the user&lsquo;s error
          status. The information collected, recorded, and analyzed by Sentry
          does not contain any personally identifiable information; please visit
