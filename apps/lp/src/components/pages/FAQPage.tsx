    ...
    items: [
      {
        ...
        answer:
          `**TrainLCDは、日本全国の鉄道路線で使える新感覚ナビゲーションアプリです。**
電車に乗っている間、現在地をリアルタイムで表示し、次の駅や乗り換え情報をわかりやすくご案内します。`,
      },
      {
        question: '開発者は誰ですか？',
        answer:
          `TrainLCDは、フリーランスエンジニアの **TinyKitten（関口 翼）** が個人で開発・運営しています。
大半のコードをオープンソースとして公開し、透明性の高い運用を心がけています。`,
      },
      {
        question: 'アプリは無料で使えますか？',
        answer:
          `**はい、TrainLCDは完全無料でご利用いただけます。**
広告表示もなく、すべての機能を無料でお使いいただけます。`,
      },
      {
        question: '広告は表示されますか？',
        answer:
          `**いいえ、TrainLCDには広告は一切表示されません。**
...
ただし、経路の選択や検索にはインターネット接続が必要です。`,
  ...
  },
  {
    ...
    items: [
      {
        question:
          '経路の選択や検索の際に、位置情報はどのように扱われますか？',
        answer:
          `**TrainLCDでは、最寄り駅を判定するためにのみ、一時的に現在地（緯度・経度）をアプリ内部のサーバーへ送信する場合があります。**
...
また、**経路検索や路線データの取得時に現在地が送信されることはありません。**`,
      },
      {
        ...
        answer:
          `**位置情報の使用を許可しない場合でも、手動で駅や路線を選択することでTrainLCDをご利用いただけます。**
    ...
    items: [
      {
        ...
        answer:
          `**TrainLCDは日本全国のJR・私鉄など、ほぼすべての鉄道路線に対応しています。**
    ...
    items: [
      {
        ...
        answer:
          `**TrainLCDはiPhone、iPad、Apple Watch、Androidスマートフォン・タブレット、Wear OSに対応しています。**
    ...
    items: [
      {
        ...
        answer:
          `**「駅データ.jp」などの路線データをもとに、一部を手動で補正して利用しています。**
実際の運行に合わせた調整も行っており、多くの路線で安定した精度でご利用いただけます。`,
      },
      {
        question: 'データの精度はどのくらいですか？',
        answer:
          `**実運行に合わせて継続的に補正しているため、ほとんどの路線で安定した精度です。**
ダイヤ改正や工事による変更があった場合など、まれに誤差が生じることがあります。`,
      },
      {
        question:'駅データや路線データの間違いを見つけました。どこに報告すればいいですか？',
    ...
    items: [
      {
        ...
        answer:
          `**デバイスの設定で位置情報サービスが有効になっているか、TrainLCDアプリに位置情報の使用許可が与えられているかご確認ください。**
また、屋内や地下では位置情報の精度が低下する場合があります。`,
      },
      {
        question: 'バッテリーの消費が気になります。',
        answer:
          `**TrainLCDはバックグラウンドでの位置情報取得を最適化していますが、長時間のご利用ではバッテリー消費が発生します。**
