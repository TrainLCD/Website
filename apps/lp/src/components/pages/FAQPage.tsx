...
const faqData: FAQCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          '一部機能はオフラインでもご利用いただけますが、リアルタイムの位置情報取得や最新の運行情報の取得にはインターネット接続が必要です。',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          'TrainLCDは日本全国のJR・私鉄・地下鉄など、ほぼすべての鉄道路線に対応しています。詳細な対応路線リストはアプリ内でご確認いただけます。',
      },
      {
        question: '新幹線でも使えますか？',
        answer:
    ...
    items: [
      {
        ...
        answer:
          '路線データは国土交通省が公開するオープンデータや、各鉄道会社が提供する公開データを利用しています。データは定期的に更新されます。',
      },
      {
        question: 'データの精度はどのくらいですか？',
        answer:
          '公式なオープンデータを基にしているため、高い精度を保っています。ただし、ダイヤ改正直後などは一時的に情報が古い場合があります。',
      },
    ],
  },
  {
