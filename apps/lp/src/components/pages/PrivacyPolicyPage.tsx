  ...
  <>
    ...
    <div className={styles.wrapper}>
      <main className={styles.container}>
        ...
        <p className={styles.paragraph}>
          リモート合成を利用する場合、読み上げる案内文（駅名や路線名などを含む文章）をGoogle LLCの提供する音声合成サービスへ送信します。送信される情報に、位置情報や利用者様を識別する情報は一切含まれません。合成された音声は、同一の案内文を繰り返し合成することを避けるため、TinyKittenの管理するサーバーに一定の期間保管されます。
          <br />
        ...
        <p className={styles.paragraph}>
          また、提案する駅の候補が利用者様の要望に合っているかを判定するために、利用者様が直近に入力された文章および乗車中の駅の名称を、提案する駅の候補の情報とあわせてTypeSafe AI, Inc.の提供するAIサービスへ送信します。
        </p>
        <p className={styles.paragraph}>
          送信された会話の内容は、応答の生成のためにのみ利用し、TinyKittenのサーバーに保管することはありません。会話の内容は利用者様の端末にも保存されず、本機能の画面を閉じると破棄されます。また、本機能の適正な運用のため、第5条の匿名の識別子を用いて1日あたりの利用回数を制限しています。
          <br />
