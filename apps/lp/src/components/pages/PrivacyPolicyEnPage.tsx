  ...
  <>
    ...
    <div className={styles.wrapper}>
      <main className={styles.container}>
        ...
        <p className={styles.paragraph}>
          The conversation sent is used only to generate a response and is not stored on TinyKitten’s servers. Nor is the conversation saved on the user’s device; it is discarded when the screen of this function is closed. In order to operate this function properly, the number of uses per day is limited using the anonymous identifier described in Article 5.
          <br />
